...
def show_changes_recipe(dinner_id):
    ...
    ingredients_recipe = rq.get_ingredient_ids_with_highest_recipe_version(current_version_id)
    ...
    if len(recipe_versions) < 2:
        ...
        # henter oppskrift, ingredienser, mengder og måleenheter
        ingredients_recipe_prev = rq.get_ingredient_ids_with_highest_recipe_version(previous_version_id)
